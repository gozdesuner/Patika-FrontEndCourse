    ...
    <section id="our-classes">
      ...
      <div className="classes">
        <div
          ...
          style={{ display: activeContent === "yoga" ? "flex" : "none" }}
        >
        ...
        <div
          id="group"
          className="content-section"
          style={{ display: activeContent === "group" ? "flex" : "none" }}
        >
          <div className="left-column">
        ...
        <div
          id="solo"
          className="content-section"
          style={{ display: activeContent === "solo" ? "flex" : "none" }}
        >
          <div className="left-column">
        ...
        <div
          id="stretching"
          className="content-section"
          style={{ display: activeContent === "stretching" ? "flex" : "none" }}
        >
          <div className="left-column">
